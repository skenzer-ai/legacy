...
interface ServiceCardWithChatProps {
  service: ServiceSummary
}

export default function ServiceCardWithChat({ service }: ServiceCardWithChatProps) {
      ...
      >
        ...
        >
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            {/* Status indicators and Chat Button */}
            <div className="flex items-center space-x-2 ml-4">
              ...
              <button
                ...
                className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-2 rounded-lg bg-gradient-to-r from-purple-500 to-blue-500 text-white hover:from-purple-600 hover:to-blue-600 shadow-lg hover:shadow-xl transform hover:scale-105"
                title={`Ask AI about ${service.service_name}`}
              >
